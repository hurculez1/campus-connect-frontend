    ...
    <div className="min-h-screen bg-mesh-dating flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          {/* Google Login — real OAuth button, no Firebase */}
          <motion.button
            whileHover={{ scale: 1.02, y: -1 }}
            whileTap={{ scale: 0.98 }}
            type="button"
            onClick={() => handleGoogleLogin()}
            className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl font-bold text-gray-800 transition-all duration-200 shadow-lg"
